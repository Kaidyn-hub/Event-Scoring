                    ...
                    categories[category].forEach((row, index) => {
                        ...
                        categoryContent += `
                            <tr data-id="${row.id}">
                                ...
                                <td><input type="number" class="gold" value="${row.gold || 0}" min="0" data-id="${row.id}" onchange="updateScore(this)"></td>
                                <td><input type="number" class="silver" value="${row.silver || 0}" min="0" data-id="${row.id}" onchange="updateScore(this)"></td>
                                <td><input type="number" class="bronze" value="${row.bronze || 0}" min="0" data-id="${row.id}" onchange="updateScore(this)"></td>
